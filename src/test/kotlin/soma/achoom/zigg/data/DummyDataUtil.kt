...
class DummyDataUtil {
    ...
    fun createDummyHistory(space: Space): History {
        val history = History(
            ...
            historyName = createRandomString(10),
            space = space,
            historyVideoKey = HISTORY_VIDEO_URL,
            historyVideoThumbnailKey = HISTORY_VIDEO_URL,
    ...
    fun createDummyFeedback(history: History, creator: User, receivers: Collection<User>): Feedback {
        val feedback = Feedback(
            feedbackId = UUID.randomUUID(),
            history = history,
            feedbackMessage = createRandomString(10),
        ...
        val feedbackRecipient = receivers.map {
            SpaceUser(
                space = history.space,
                user = it,
                spaceRole = SpaceRole.USER
    ...
    fun creatDummyInvite(invitee: User, inviter: User, space: Space): Invite {
        val invite = Invite(
